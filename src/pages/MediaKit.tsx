...
import { Users, Eye, VideoIcon, TrendingUp, Calendar, Award, Mail } from 'lucide-react';
import { useYouTubeStats } from '../hooks/useYouTubeStats';

export const MediaKit: React.FC = () => {
  const { stats, averageViews, engagementRate, recentVideosCount, loading, error } = useYouTubeStats();
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-gray-500 mt-4">Chargement des statistiques YouTube...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">(likes + commentaires / vues)</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <h3 className="text-3xl font-bold text-[#141414] mb-2">
              {(() => {
                ...
                return diffInMonths < 12 ? `${diffInMonths} mois` : `${Math.floor(diffInMonths / 12)} an${Math.floor(diffInMonths / 12) > 1 ? 's' : ''}`;
              })()}
            </h3>
        ...
        <div className="bg-gradient-to-br from-[#398FBA] to-[#2a6d94] rounded-2xl p-8 text-white text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              ...
              <p className="opacity-90 text-sm">Reviews honnêtes et détaillées</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <div className="mt-6">
                <a
                  href="mailto:contact@aylabs.com"
